    ...
    <div class="main-content">
        <header class="topbar">
            ...
            <div class="topbar-right">
                <?php if ($unread > 0): ?>
                <a href="notifikasi.php?read_all=1" class="btn btn-outline btn-sm">✓ Tandai Semua Dibaca</a>
                <?php endif; ?>
            </div>
        </header>
            ...
            <div class="card">
                ...
                <table>
                    ...
                    <tr style="<?= !$n['is_read'] ? 'background:#eff6ff' : '' ?>">
                        ...
                        <td><a href="ticket_detail.php?uid=<?= urlencode($n['tiket_uid']) ?>" class="btn btn-sm btn-primary">💬 Buka</a></td>
                    </tr>
                    <?php endwhile; ?>
                    </tbody>
                </table>
