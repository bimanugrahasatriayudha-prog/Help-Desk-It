    ...
    <div class="main-content">
        ...
        <header class="topbar">
            ...
            <div class="topbar-right">
                ...
                <div style="position:relative">
                    ...
                    <div class="notif-dropdown" id="notifDropdown">
                        <div class="notif-dropdown-header">
                            🔔 Notifikasi
                            <a href="notifikasi" style="font-size:.73rem;color:var(--primary)">Lihat Semua</a>
                        </div>
                        <?php
                        ...
                        while ($n = $notifs->fetch_assoc()):
                            $hasNotif = true;
                        ?>
                        <a href="ticket_detail?uid=<?= urlencode($n['uid_ticket']) ?>" class="notif-item <?= !$n['is_read']?'unread':'' ?>" style="display:block">
                ...
                <a href="../index" target="_blank" class="btn btn-outline btn-sm">🌐 Form User</a>
            </div>
        </header>
        ...
        <main class="page-content">
            ...
            <div class="high-alert">
                ...
                <a href="tickets?prioritas=High" style="margin-left:auto;font-weight:600;text-decoration:underline">Tangani →</a>
            </div>
            <?php endif; ?>
            ...
            <div class="grid-2">
                ...
                <div class="card col-2">
                    <div class="card-header">
                        <h3>🎫 Tiket Terbaru</h3>
                        <a href="tickets" class="btn btn-sm btn-primary">Lihat Semua</a>
                    </div>
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="ticket_detail?uid=<?= urlencode($row['uid']) ?>" class="btn btn-sm btn-outline">👁 Detail</a>
                            </td>
                        </tr>
                        <?php endwhile; ?>
                        </tbody>
                ...
                <div class="card">
                    ...
                    <div class="card-body" style="display:flex;flex-direction:column;gap:9px">
                        <a href="tickets?status=Open" class="btn btn-primary">📬 Tangani Tiket Open (<?= $open ?>)</a>
                        <a href="tickets?status=Waiting+Confirm" class="btn btn-outline">🕐 Waiting Confirm (<?= $waiting ?>)</a>
                        <a href="tickets?prioritas=High" class="btn btn-outline" style="color:var(--danger);border-color:var(--danger)">🔴 High Priority (<?= $high ?>)</a>
                        <a href="notifikasi" class="btn btn-outline">🔔 Notifikasi (<?= $unread ?> baru)</a>
                        <hr class="divider">
                        <a href="admins" class="btn btn-outline">👤 Kelola Admin</a>
                    </div>
                </div>
            </div>
        </main>
