...
define('MAIL_USERNAME',   'email-brevo-kamu@domain.com');  // ← login Brevo kamu
define('MAIL_PASSWORD',   'xsmtpib-xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx'); // ← SMTP key Brevo
define('MAIL_FROM_EMAIL', 'helpdesk@domain.com');          // ← verified sender di Brevo
